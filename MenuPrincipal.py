...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_pp.setGeometry(QtCore.QRect(350, 450, 141, 31))
        self.btn_pp.setObjectName("btn_pp")
        self.btn_pa = QtWidgets.QPushButton(self.centralwidget)
        self.btn_pa.setGeometry(QtCore.QRect(130, 450, 141, 31))
        self.btn_pa.setObjectName("btn_pa")

        self.btn_compara = QtWidgets.QPushButton(self.centralwidget)
        self.btn_compara.setGeometry(QtCore.QRect(130, 500, 141, 31))
        self.btn_compara.setObjectName("btn_compara")

        self.btn_prueba = QtWidgets.QPushButton(self.centralwidget)
        self.btn_prueba.setGeometry(QtCore.QRect(350, 500, 141, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_compara.setText(_translate("MainWindow", "Compara Laberintos"))
        self.btn_reload.setText(_translate("MainWindow", "Regenerar Laberinto"))
        self.btn_prueba.setText(_translate("MainWindow", "Ejecuta Pruebas"))
        self.label_2.setText(_translate("MainWindow", "Tamaño del Laberinto: "))
        self.label_3.setText(_translate("MainWindow", "Ingrese el tamaño del laberinto(rango entre 5-50):"))
